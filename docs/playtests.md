...
## DRO-36 — Slowing beams and module jammers — 2026-09-18

Added catalog-only Slowing beam, Module jammer and Mixed control scenarios.
Warnings require range/clear sight; beams slow horizontal flight without stacking,
...
range and HUD-clearance fixes; re-review found no remaining actionable findings.
