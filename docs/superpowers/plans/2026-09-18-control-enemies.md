...
- [ ] Add failing production integration tests in `src/combat/control_tests.rs`
...
- [ ] Implement `src/combat/control.rs`: `ControlAttack` phases and
...
- [ ] Implement `src/combat/control_scene.rs` with cached meshes/materials,
...
- [ ] Add native `DRONE_CONTROL_SMOKE` fixture in catalog validation. Check
